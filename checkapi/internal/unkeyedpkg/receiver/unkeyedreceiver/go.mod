module github.com/open-telemetry/opentelemetry-go-build-tools/checkapi/internal/testpkg/receiver/unkeyedreceiver

go 1.23.7

require go.opentelemetry.io/collector/receiver v1.32.0
...
require (
	...
	go.opentelemetry.io/otel/log v0.12.0 // indirect
	go.opentelemetry.io/otel/log/logtest v0.0.0-20250521073539-a85ae98dcedc // indirect
